import { Attachment, Message } from "@/lib/drizzle/drizzle-schema";
...
export const MessageItem = ({
  ...
  const imageFiles =
    message.attachments?.map((attachment: Partial<Attachment>) => {
      // Create a mock File object with the URL for display
      const mockFile = new File([], attachment.name || "unknown", {
